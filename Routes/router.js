...
const postController = require("C:/Users/VNSV/WebstormProjects/BlockchainT2/controllers/postController");
const commentController = require("C:/Users/VNSV/WebstormProjects/BlockchainT2/controllers/commentController");
...
router.post("/user/profile/addPost",authorizationCheck, postController.addPost);
// END OF USER PROFILE
...
router.post(
  "/user/profile/avatar",
  upload.single("avatar"), authorizationCheck,
