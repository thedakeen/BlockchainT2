...
function executionPayloadFromBeaconPayload(payload) {
    const executionPayload = {
        ...
        blockNumber: (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.block_number)),
        gasLimit: (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.gas_limit)),
        gasUsed: (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.gas_used)),
        timestamp: (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.timestamp)),
        extraData: payload.extra_data,
        baseFeePerGas: (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.base_fee_per_gas)),
    ...
    if (payload.withdrawals !== undefined && payload.withdrawals !== null) {
        executionPayload.withdrawals = payload.withdrawals.map((wd) => ({
            index: (0, ethereumjs_util_1.bigIntToHex)(BigInt(wd.index)),
            validatorIndex: (0, ethereumjs_util_1.bigIntToHex)(BigInt(wd.validator_index)),
            address: wd.address,
            amount: (0, ethereumjs_util_1.bigIntToHex)(BigInt(wd.amount)),
        }));
    }
    if (payload.blob_gas_used !== undefined && payload.blob_gas_used !== null) {
        executionPayload.blobGasUsed = (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.blob_gas_used));
    }
    if (payload.excess_blob_gas !== undefined && payload.excess_blob_gas !== null) {
        executionPayload.excessBlobGas = (0, ethereumjs_util_1.bigIntToHex)(BigInt(payload.excess_blob_gas));
    }
