...
class BlockHeader {
    ...
    constructor(headerData, opts = {}) {
        ...
        if (opts.common) {
            ...
            this.common = new ethereumjs_common_1.Common({
        ...
        const defaults = {
            ...
            difficulty: ethereumjs_util_1.BIGINT_0,
            number: ethereumjs_util_1.BIGINT_0,
            gasLimit: DEFAULT_GAS_LIMIT,
            gasUsed: ethereumjs_util_1.BIGINT_0,
            timestamp: ethereumjs_util_1.BIGINT_0,
            extraData: new Uint8Array(0),
            mixHash: (0, ethereumjs_util_1.zeros)(32),
            nonce: (0, ethereumjs_util_1.zeros)(8),
        };
        const parentHash = (0, ethereumjs_util_1.toType)(headerData.parentHash, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.parentHash;
        const uncleHash = (0, ethereumjs_util_1.toType)(headerData.uncleHash, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.uncleHash;
        const coinbase = new ethereumjs_util_1.Address((0, ethereumjs_util_1.toType)(headerData.coinbase ?? defaults.coinbase, ethereumjs_util_1.TypeOutput.Uint8Array));
        const stateRoot = (0, ethereumjs_util_1.toType)(headerData.stateRoot, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.stateRoot;
        const transactionsTrie = (0, ethereumjs_util_1.toType)(headerData.transactionsTrie, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.transactionsTrie;
        const receiptTrie = (0, ethereumjs_util_1.toType)(headerData.receiptTrie, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.receiptTrie;
        const logsBloom = (0, ethereumjs_util_1.toType)(headerData.logsBloom, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.logsBloom;
        ...
        const extraData = (0, ethereumjs_util_1.toType)(headerData.extraData, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.extraData;
        const mixHash = (0, ethereumjs_util_1.toType)(headerData.mixHash, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.mixHash;
        const nonce = (0, ethereumjs_util_1.toType)(headerData.nonce, ethereumjs_util_1.TypeOutput.Uint8Array) ?? defaults.nonce;
        ...
        const hardforkDefaults = {
            baseFeePerGas: this.common.isActivatedEIP(1559)
                ? number === this.common.hardforkBlock(ethereumjs_common_1.Hardfork.London)
                    ? this.common.param('gasConfig', 'initialBaseFee')
                    : ethereumjs_util_1.BIGINT_7
                : undefined,
            withdrawalsRoot: this.common.isActivatedEIP(4895) ? ethereumjs_util_1.KECCAK256_RLP : undefined,
            blobGasUsed: this.common.isActivatedEIP(4844) ? ethereumjs_util_1.BIGINT_0 : undefined,
            excessBlobGas: this.common.isActivatedEIP(4844) ? ethereumjs_util_1.BIGINT_0 : undefined,
            parentBeaconBlockRoot: this.common.isActivatedEIP(4788) ? (0, ethereumjs_util_1.zeros)(32) : undefined,
        };
        ...
        const withdrawalsRoot = (0, ethereumjs_util_1.toType)(headerData.withdrawalsRoot, ethereumjs_util_1.TypeOutput.Uint8Array) ?? hardforkDefaults.withdrawalsRoot;
        const blobGasUsed = (0, ethereumjs_util_1.toType)(headerData.blobGasUsed, ethereumjs_util_1.TypeOutput.BigInt) ?? hardforkDefaults.blobGasUsed;
        const excessBlobGas = (0, ethereumjs_util_1.toType)(headerData.excessBlobGas, ethereumjs_util_1.TypeOutput.BigInt) ?? hardforkDefaults.excessBlobGas;
        const parentBeaconBlockRoot = (0, ethereumjs_util_1.toType)(headerData.parentBeaconBlockRoot, ethereumjs_util_1.TypeOutput.Uint8Array) ??
        ...
        if (opts.calcDifficultyFromHeader &&
            this.common.consensusAlgorithm() === ethereumjs_common_1.ConsensusAlgorithm.Ethash) {
        ...
        if (opts.cliqueSigner) {
            ...
            if (this.extraData.length < minExtraDataLength) {
                ...
                this.extraData = (0, ethereumjs_util_1.concatBytes)(this.extraData, new Uint8Array(remainingLength));
            }
    ...
    static fromRLPSerializedHeader(serializedHeaderData, opts = {}) {
        const values = ethereumjs_rlp_1.RLP.decode(serializedHeaderData);
    ...
    static fromValuesArray(values, opts = {}) {
        ...
        if (header.common.isActivatedEIP(1559) && baseFeePerGas === undefined) {
            const eip1559ActivationBlock = (0, ethereumjs_util_1.bigIntToBytes)(header.common.eipBlock(1559));
            // eslint-disable-next-line @typescript-eslint/strict-boolean-expressions
            if (eip1559ActivationBlock && (0, ethereumjs_util_1.equalsBytes)(eip1559ActivationBlock, number)) {
    ...
    _genericFormatValidation() {
        ...
        if (this.common.isActivatedEIP(1559) === true) {
            ...
            const londonHfBlock = this.common.hardforkBlock(ethereumjs_common_1.Hardfork.London);
            if (typeof londonHfBlock === 'bigint' &&
                londonHfBlock !== ethereumjs_util_1.BIGINT_0 &&
    ...
    _consensusFormatValidation() {
        ...
        if (this.common.consensusAlgorithm() === ethereumjs_common_1.ConsensusAlgorithm.Ethash) {
            // PoW/Ethash
        ...
        if (this.common.consensusAlgorithm() === ethereumjs_common_1.ConsensusAlgorithm.Clique) {
            // PoA/Clique
            ...
            // MixHash format
            if (!(0, ethereumjs_util_1.equalsBytes)(this.mixHash, new Uint8Array(32))) {
                const msg = this._errorMsg(`mixHash must be filled with zeros, received ${this.mixHash}`);
                throw new Error(msg);
            }
        }
        // Validation for PoS blocks (EIP-3675)
        if (this.common.consensusType() === ethereumjs_common_1.ConsensusType.ProofOfStake) {
            let error = false;
            let errorMsg = '';
            if (!(0, ethereumjs_util_1.equalsBytes)(uncleHash, ethereumjs_util_1.KECCAK256_RLP_ARRAY)) {
                errorMsg += `, uncleHash: ${(0, ethereumjs_util_1.bytesToHex)(uncleHash)} (expected: ${(0, ethereumjs_util_1.bytesToHex)(ethereumjs_util_1.KECCAK256_RLP_ARRAY)})`;
                error = true;
            }
            if (number !== ethereumjs_util_1.BIGINT_0) {
                // Skip difficulty, nonce, and extraData check for PoS genesis block as genesis block may have non-zero difficulty (if TD is > 0)
                if (difficulty !== ethereumjs_util_1.BIGINT_0) {
                    errorMsg += `, difficulty: ${difficulty} (expected: 0)`;
                    error = true;
                }
                if (extraData.length > 32) {
                    errorMsg += `, extraData: ${(0, ethereumjs_util_1.bytesToHex)(extraData)} (cannot exceed 32 bytes length, received ${extraData.length} bytes)`;
                    error = true;
                }
                if (!(0, ethereumjs_util_1.equalsBytes)(nonce, (0, ethereumjs_util_1.zeros)(8))) {
                    errorMsg += `, nonce: ${(0, ethereumjs_util_1.bytesToHex)(nonce)} (expected: ${(0, ethereumjs_util_1.bytesToHex)((0, ethereumjs_util_1.zeros)(8))})`;
                    error = true;
                }
            }
            if (error) {
    ...
    validateGasLimit(parentBlockHeader) {
        ...
        const londonHardforkBlock = this.common.hardforkBlock(ethereumjs_common_1.Hardfork.London);
        if (typeof londonHardforkBlock === 'bigint' &&
            londonHardforkBlock !== ethereumjs_util_1.BIGINT_0 &&
    ...
    calcNextBaseFee() {
        ...
        if (parentGasTarget === this.gasUsed) {
            ...
            nextBaseFee = (calculatedDelta > ethereumjs_util_1.BIGINT_1 ? calculatedDelta : ethereumjs_util_1.BIGINT_1) + this.baseFeePerGas;
        }
        else {
            ...
            const calculatedDelta = (this.baseFeePerGas * gasUsedDelta) / parentGasTarget / baseFeeMaxChangeDenominator;
            nextBaseFee =
                this.baseFeePerGas - calculatedDelta > ethereumjs_util_1.BIGINT_0
                    ? this.baseFeePerGas - calculatedDelta
                    : ethereumjs_util_1.BIGINT_0;
        }
        return nextBaseFee;
    }
    /**
    ...
    getBlobGasPrice() {
        ...
        return (0, helpers_js_1.fakeExponential)(this.common.param('gasPrices', 'minBlobGasPrice'), this.excessBlobGas, this.common.param('gasConfig', 'blobGasPriceUpdateFraction'));
    }
    /**
    ...
    calcNextExcessBlobGas() {
        ...
        const targetGasConsumed = (this.excessBlobGas ?? ethereumjs_util_1.BIGINT_0) + (this.blobGasUsed ?? ethereumjs_util_1.BIGINT_0);
    ...
    raw() {
        const rawItems = [
            ...
            this.receiptTrie,
            this.logsBloom,
            (0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.difficulty),
            (0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.number),
            (0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.gasLimit),
            (0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.gasUsed),
            (0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.timestamp ?? ethereumjs_util_1.BIGINT_0),
            this.extraData,
            this.mixHash,
            this.nonce,
        ];
        if (this.common.isActivatedEIP(1559) === true) {
            rawItems.push((0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.baseFeePerGas));
        }
        if (this.common.isActivatedEIP(4895) === true) {
        ...
        if (this.common.isActivatedEIP(4844) === true) {
            rawItems.push((0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.blobGasUsed));
            rawItems.push((0, ethereumjs_util_1.bigIntToUnpaddedBytes)(this.excessBlobGas));
        }
        if (this.common.isActivatedEIP(4788) === true) {
    ...
    hash() {
        if (Object.isFrozen(this)) {
            if (!this.cache.hash) {
                this.cache.hash = this.keccakFunction(ethereumjs_rlp_1.RLP.encode(this.raw()));
            }
            return this.cache.hash;
        }
        return this.keccakFunction(ethereumjs_rlp_1.RLP.encode(this.raw()));
    }
    /**
     * Checks if the block header is a genesis header.
     */
    isGenesis() {
        return this.number === ethereumjs_util_1.BIGINT_0;
    }
    _requireClique(name) {
        if (this.common.consensusAlgorithm() !== ethereumjs_common_1.ConsensusAlgorithm.Clique) {
    ...
    ethashCanonicalDifficulty(parentBlockHeader) {
        if (this.common.consensusType() !== ethereumjs_common_1.ConsensusType.ProofOfWork) {
        ...
        if (this.common.gteHardfork(ethereumjs_common_1.Hardfork.Byzantium) === true) {
            ...
            const uncleAddend = (0, ethereumjs_util_1.equalsBytes)(parentBlockHeader.uncleHash, ethereumjs_util_1.KECCAK256_RLP_ARRAY) ? 1 : 2;
        ...
        if (this.common.gteHardfork(ethereumjs_common_1.Hardfork.Byzantium) === true) {
            ...
            if (num < ethereumjs_util_1.BIGINT_0) {
                num = ethereumjs_util_1.BIGINT_0;
            }
        }
        else if (this.common.gteHardfork(ethereumjs_common_1.Hardfork.Homestead) === true) {
            // 1 - (block_timestamp - parent_timestamp) // 10
            let a = ethereumjs_util_1.BIGINT_1 - (blockTs - parentTs) / BigInt(10);
            const cutoff = BigInt(-99);
            // MAX(cutoff, a)
            if (cutoff > a) {
                a = cutoff;
        ...
        const exp = num / BigInt(100000) - ethereumjs_util_1.BIGINT_2;
        if (exp >= 0) {
            dif = dif + ethereumjs_util_1.BIGINT_2 ** exp;
        }
    ...
    cliqueSigHash() {
        ...
        return this.keccakFunction(ethereumjs_rlp_1.RLP.encode(raw));
    }
    /**
    ...
    cliqueIsEpochTransition() {
        ...
        return this.number % epoch === ethereumjs_util_1.BIGINT_0;
    }
    /**
    ...
    cliqueSealBlock(privateKey) {
        ...
        const signatureB = (0, ethereumjs_util_1.concatBytes)(signature.r, signature.s, (0, ethereumjs_util_1.bigIntToBytes)(signature.v - ethereumjs_util_1.BIGINT_27));
        const extraDataWithoutSeal = this.extraData.subarray(0, this.extraData.length - clique_js_1.CLIQUE_EXTRA_SEAL);
        const extraData = (0, ethereumjs_util_1.concatBytes)(extraDataWithoutSeal, signatureB);
        return extraData;
    }
    /**
    ...
    cliqueSigner() {
        ...
        if (extraSeal.length === 0 || (0, ethereumjs_util_1.equalsBytes)(extraSeal, new Uint8Array(65))) {
            return ethereumjs_util_1.Address.zero();
        }
        const r = extraSeal.subarray(0, 32);
        const s = extraSeal.subarray(32, 64);
        const v = (0, ethereumjs_util_1.bytesToBigInt)(extraSeal.subarray(64, 65)) + ethereumjs_util_1.BIGINT_27;
    ...
    toJSON() {
        const withdrawalAttr = this.withdrawalsRoot
            ? { withdrawalsRoot: (0, ethereumjs_util_1.bytesToHex)(this.withdrawalsRoot) }
            : {};
        const jsonDict = {
            parentHash: (0, ethereumjs_util_1.bytesToHex)(this.parentHash),
            uncleHash: (0, ethereumjs_util_1.bytesToHex)(this.uncleHash),
            coinbase: this.coinbase.toString(),
            stateRoot: (0, ethereumjs_util_1.bytesToHex)(this.stateRoot),
            transactionsTrie: (0, ethereumjs_util_1.bytesToHex)(this.transactionsTrie),
            ...withdrawalAttr,
            receiptTrie: (0, ethereumjs_util_1.bytesToHex)(this.receiptTrie),
            logsBloom: (0, ethereumjs_util_1.bytesToHex)(this.logsBloom),
            ...
            extraData: (0, ethereumjs_util_1.bytesToHex)(this.extraData),
            mixHash: (0, ethereumjs_util_1.bytesToHex)(this.mixHash),
            nonce: (0, ethereumjs_util_1.bytesToHex)(this.nonce),
        };
        if (this.common.isActivatedEIP(1559) === true) {
            jsonDict.baseFeePerGas = (0, ethereumjs_util_1.bigIntToHex)(this.baseFeePerGas);
        }
        if (this.common.isActivatedEIP(4844) === true) {
            jsonDict.blobGasUsed = (0, ethereumjs_util_1.bigIntToHex)(this.blobGasUsed);
            jsonDict.excessBlobGas = (0, ethereumjs_util_1.bigIntToHex)(this.excessBlobGas);
        }
        if (this.common.isActivatedEIP(4788) === true) {
            jsonDict.parentBeaconBlockRoot = (0, ethereumjs_util_1.bytesToHex)(this.parentBeaconBlockRoot);
        }
        return jsonDict;
    }
    /**
    ...
    _validateDAOExtraData() {
        if (this.common.hardforkIsActiveOnBlock(ethereumjs_common_1.Hardfork.Dao, this.number) === false) {
            return;
        }
        const DAOActivationBlock = this.common.hardforkBlock(ethereumjs_common_1.Hardfork.Dao);
        if (DAOActivationBlock === null || this.number < DAOActivationBlock) {
            return;
        }
        const DAO_ExtraData = (0, ethereumjs_util_1.hexToBytes)('0x64616f2d686172642d666f726b');
        const DAO_ForceExtraDataRange = BigInt(9);
        const drift = this.number - DAOActivationBlock;
        if (drift <= DAO_ForceExtraDataRange && !(0, ethereumjs_util_1.equalsBytes)(this.extraData, DAO_ExtraData)) {
    ...
    errorStr() {
        let hash = '';
        try {
            hash = (0, ethereumjs_util_1.bytesToHex)(this.hash());
        }
        catch (e) {
            hash = 'error';
        }
