import { Chain, Common, ConsensusAlgorithm, ConsensusType, Hardfork, } from '@nomicfoundation/ethereumjs-common';
import { RLP } from '@nomicfoundation/ethereumjs-rlp';
import { Address, BIGINT_0, BIGINT_1, BIGINT_2, BIGINT_27, BIGINT_7, KECCAK256_RLP, KECCAK256_RLP_ARRAY, TypeOutput, bigIntToBytes, bigIntToHex, bigIntToUnpaddedBytes, bytesToBigInt, bytesToHex, concatBytes, ecrecover, ecsign, equalsBytes, hexToBytes, toType, zeros, } from '@nomicfoundation/ethereumjs-util';
...
export class BlockHeader {
    ...
    getBlobGasPrice() {
        ...
        return fakeExponential(this.common.param('gasPrices', 'minBlobGasPrice'), this.excessBlobGas, this.common.param('gasConfig', 'blobGasPriceUpdateFraction'));
    }
    /**
