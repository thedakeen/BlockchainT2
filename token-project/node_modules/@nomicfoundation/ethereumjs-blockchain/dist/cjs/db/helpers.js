...
function DBSetTD(TD, blockNumber, blockHash) {
    return operation_js_1.DBOp.set(operation_js_1.DBTarget.TotalDifficulty, ethereumjs_rlp_1.RLP.encode(TD), {
        blockNumber,
        blockHash,
    });
}
...
function DBSetBlockOrHeader(blockBody) {
    ...
    const isGenesis = header.number === ethereumjs_util_1.BIGINT_0;
    if (isGenesis ||
        ...
        const bodyValue = ethereumjs_rlp_1.RLP.encode(blockBody.raw().slice(1));
