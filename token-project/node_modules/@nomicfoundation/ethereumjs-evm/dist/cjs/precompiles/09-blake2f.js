...
function precompile09(opts) {
    ...
    if (opts._debug !== undefined) {
        opts._debug(`Run BLAKE2F (0x09) precompile data=${(0, ethereumjs_util_1.short)(opts.data)} length=${opts.data.length} gasLimit=${opts.gasLimit} gasUsed=${gasUsed}`);
    }
    ...
    if (opts._debug !== undefined) {
        opts._debug(`BLAKE2F (0x09) return hash=${(0, ethereumjs_util_1.bytesToHex)(output)}`);
    }
    return {
