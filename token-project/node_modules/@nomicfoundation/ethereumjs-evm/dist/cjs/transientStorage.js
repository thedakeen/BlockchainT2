...
class TransientStorage {
    ...
    get(addr, key) {
        ...
        const value = map.get((0, ethereumjs_util_1.bytesToHex)(key));
        if (!value) {
            return new Uint8Array(32);
        }
        return value;
    ...
    put(addr, key, value) {
        ...
        const keyStr = (0, ethereumjs_util_1.bytesToHex)(key);
    ...
    toJSON() {
        ...
        for (const [address, map] of this._storage.entries()) {
            ...
            for (const [key, value] of map.entries()) {
                result[address][key] = (0, ethereumjs_util_1.bytesToHex)(value);
            }
        }
        return result;
    }
