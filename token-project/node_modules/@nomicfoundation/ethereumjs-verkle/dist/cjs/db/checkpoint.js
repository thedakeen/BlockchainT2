...
class CheckpointDB {
        ...
        if (!this.hasCheckpoints()) {
            ...
            for (const [key, value] of keyValueMap.entries()) {
                if (value === undefined) {
                    batchOp.push({
                        type: 'del',
                        key: (0, ethereumjs_util_1.hexToBytes)(key),
                        opts: {
                    ...
                    batchOp.push({
                        ...
                        key: (0, ethereumjs_util_1.hexToBytes)(key),
                        value,
                        opts: { keyEncoding: ethereumjs_util_1.KeyEncoding.Bytes, valueEncoding: ethereumjs_util_1.ValueEncoding.Bytes },
                    });
                }
            }
     ...
     */
    async get(key) {
        const keyHex = (0, ethereumjs_util_1.bytesToHex)(key);
