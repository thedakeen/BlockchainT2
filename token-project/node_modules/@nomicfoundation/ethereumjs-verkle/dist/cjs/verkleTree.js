...
class VerkleTree {
    ...
    constructor(opts) {
        ...
        this.EMPTY_TREE_ROOT = (0, ethereumjs_util_1.zeros)(32);
    ...
    async checkRoot(root) {
        try {
            ...
            if (error.message === 'Missing node in DB') {
                return (0, ethereumjs_util_1.equalsBytes)(root, this.EMPTY_TREE_ROOT);
            }
            else {
                throw error;
            }
        ...
        return new Promise(async (resolve, reject) => {
            ...
            const onFound = async (_, node, keyProgress, walkController) => {
                ...
                if (node instanceof internalNode_js_1.InternalNode) {
                    ...
                    if ((0, ethereumjs_util_1.equalsBytes)(stem, node.stem)) {
