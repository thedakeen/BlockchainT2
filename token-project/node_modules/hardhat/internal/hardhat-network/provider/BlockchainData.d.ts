...
export declare class BlockchainData {
    ...
    getBlockByHash(blockHash: Uint8Array): Block | undefined;
    getBlockByTransactionHash(transactionHash: Uint8Array): Block | undefined;
    getTransaction(transactionHash: Uint8Array): TypedTransaction | undefined;
    getTransactionReceipt(transactionHash: Uint8Array): RpcReceiptOutput | undefined;
    getTotalDifficulty(blockHash: Uint8Array): bigint | undefined;
