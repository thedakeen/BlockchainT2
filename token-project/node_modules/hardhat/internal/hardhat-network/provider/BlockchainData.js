...
class BlockchainData {
    ...
    getBlockByHash(blockHash) {
        return this._blocksByHash.get((0, ethereumjs_util_1.bytesToHex)(blockHash));
    }
    getBlockByTransactionHash(transactionHash) {
        return this._blocksByTransactions.get((0, ethereumjs_util_1.bytesToHex)(transactionHash));
    }
    getTransaction(transactionHash) {
        return this._transactions.get((0, ethereumjs_util_1.bytesToHex)(transactionHash));
    }
    getTransactionReceipt(transactionHash) {
        return this._transactionReceipts.get((0, ethereumjs_util_1.bytesToHex)(transactionHash));
    }
    getTotalDifficulty(blockHash) {
        return this._totalDifficulty.get((0, ethereumjs_util_1.bytesToHex)(blockHash));
    }
    ...
    addBlock(block, totalDifficulty) {
        const blockHash = (0, ethereumjs_util_1.bytesToHex)(block.hash());
        ...
        for (const transaction of block.transactions) {
            const transactionHash = (0, ethereumjs_util_1.bytesToHex)(transaction.hash());
    ...
    addTransaction(transaction) {
        this._transactions.set((0, ethereumjs_util_1.bytesToHex)(transaction.hash()), transaction);
    }
