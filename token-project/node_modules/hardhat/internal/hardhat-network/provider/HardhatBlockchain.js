...
class HardhatBlockchain extends BlockchainBase_1.BlockchainBase {
    ...
    getIteratorHead(_name) {
        throw new Error("Method not implemented.");
    }
    setIteratorHead(_tag, _headHash) {
        throw new Error("Method not implemented.");
    }
    ...
    _validateBlock(block) {
        ...
        if ((blockNumber === 0n && !(0, ethereumjs_util_1.equalsBytes)(parentHash, (0, ethereumjs_util_1.zeros)(32))) ||
            (blockNumber > 0 &&
                parent !== undefined &&
                !(0, ethereumjs_util_1.equalsBytes)(parentHash, parent.hash()))) {
