...
import { Common, StateManagerInterface } from "@nomicfoundation/ethereumjs-common";
...
export declare class TxPool {
    ...
    constructor(_stateManager: StateManagerInterface, blockGasLimit: bigint, common: Common);
