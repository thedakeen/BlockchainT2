...
import { AccessListEIP2930TxData, LegacyTxData } from "@nomicfoundation/ethereumjs-tx";
...
export declare function rpcToTxData(rpcTransaction: RpcTransaction): LegacyTxData | AccessListEIP2930TxData | FeeMarketEIP1559TxData;
export {};
