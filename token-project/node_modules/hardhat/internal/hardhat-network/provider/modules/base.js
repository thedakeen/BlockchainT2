...
class Base {
    ...
    _newBlockTagToString(tag) {
        ...
        return (0, ethereumjs_util_1.bytesToHex)(tag.blockHash);
    }
    async _getDefaultCallFrom() {
        const localAccounts = await this._node.getLocalAccountAddresses();
        if (localAccounts.length === 0) {
            return Buffer.from((0, ethereumjs_util_1.toBytes)((0, ethereumjs_util_1.zeroAddress)()));
        }
        return Buffer.from((0, ethereumjs_util_1.toBytes)(localAccounts[0]));
    }
}
exports.Base = Base;
