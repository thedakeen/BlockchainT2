...
export declare class ModulesLogger {
    ...
    logBlockFromAutomine(result: MineBlockResult, codes: Uint8Array[], txHashToHighlight: Uint8Array): void;
    logMinedBlock(result: MineBlockResult, codes: Buffer[]): void;
    logIntervalMinedBlock(result: MineBlockResult, codes: Buffer[]): void;
    logSingleTransaction(tx: TypedTransaction, block: Block, txGasUsed: bigint, txTrace: GatherTracesResult, code: Buffer): void;
    logCurrentlySentTransaction(tx: TypedTransaction, txGasUsed: bigint, txTrace: GatherTracesResult, code: Buffer, block: Block): void;
    ...
    logMinedBlockNumber(blockNumber: bigint, isEmpty: boolean, baseFeePerGas?: bigint): void;
     ...
     */
    printLogs(): boolean;
    printIntervalMinedBlockNumber(blockNumber: bigint, isEmpty: boolean, baseFeePerGas?: bigint): void;
    logEmptyHardhatMinedBlock(blockNumber: bigint, baseFeePerGas?: bigint): void;
