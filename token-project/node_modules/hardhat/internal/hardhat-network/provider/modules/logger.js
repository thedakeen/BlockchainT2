...
class ModulesLogger {
        ...
        this._indent(() => {
            ...
            this._indent(() => {
                ...
                for (let i = 0; i < block.transactions.length; i++) {
                    ...
                    const code = codes[i];
                    const highlightTxHash = (0, ethereumjs_util_1.equalsBytes)(tx.hash(), txHashToHighlight);
    ...
    logSingleTransaction(tx, block, txGasUsed, txTrace, code) {
        this._indent(() => {
            ...
            const txHash = (0, ethereumjs_util_1.bytesToHex)(tx.hash());
            ...
            this._logWithTitle(`Block #${block.header.number}`, (0, ethereumjs_util_1.bytesToHex)(block.hash()));
    ...
    _logTxInsideBlock(tx, txTrace, code, txGasUsed, { highlightTxHash, }) {
        ...
        let txHash = (0, ethereumjs_util_1.bytesToHex)(tx.hash());
        if (highlightTxHash) {
    ...
    _logContractAndFunctionName(trace, code, { printNonContractCalled = false, } = {}) {
        ...
        if ((0, message_trace_1.isCreateTrace)(trace)) {
            ...
            if (trace.deployedContract !== undefined && trace.error === undefined) {
                this._logWithTitle("Contract address", (0, ethereumjs_util_1.bytesToHex)(trace.deployedContract));
            }
            return;
        }
        if (code.length === 0) {
    ...
    _logTxTo(to, trace) {
        ...
        const toString = (0, ethereumjs_util_1.bytesToHex)(to);
    ...
    _logTxFrom(from) {
        this._logWithTitle("From", (0, ethereumjs_util_1.bytesToHex)(from));
    }
    _logBlockNumber(block) {
        this._log(`Block #${block.header.number}: ${(0, ethereumjs_util_1.bytesToHex)(block.hash())}`);
    }
    ...
    _logBlockHash(block) {
        this._log(`Block: ${(0, ethereumjs_util_1.bytesToHex)(block.hash())}`);
    }
