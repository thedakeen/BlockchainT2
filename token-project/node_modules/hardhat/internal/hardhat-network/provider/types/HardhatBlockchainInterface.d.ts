...
export interface HardhatBlockchainInterface extends BlockchainInterface {
    ...
    reserveBlocks(count: bigint, interval: bigint, previousBlockStateRoot: Uint8Array, previousBlockTotalDifficulty: bigint, previousBlockBaseFeePerGas: bigint | undefined): void;
    ...
    getTransactionReceipt(transactionHash: Uint8Array): Promise<RpcReceiptOutput | null>;
}
