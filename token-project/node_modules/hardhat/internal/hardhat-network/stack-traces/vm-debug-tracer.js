...
const journal_1 = require("@nomicfoundation/ethereumjs-evm/dist/cjs/journal");
...
class VMDebugTracer {
    ...
    async _stepToStructLog(step) {
        ...
        if (step.opcode.name === "SLOAD") {
            ...
            const length = (0, ethereumjs_util_1.bytesToBigInt)(lengthBuffer);
            const offset = (0, ethereumjs_util_1.bytesToBigInt)(offsetBuffer);
            ...
            const memoryUsed = (0, ethereumjs_util_1.bytesToBigInt)(memoryUsedBuffer);
            ...
            const callCost = (0, ethereumjs_util_1.bytesToBigInt)(callCostBuffer);
            const value = (0, ethereumjs_util_1.bytesToBigInt)(valueBuffer);
            const memoryLength = BigInt(memory.length);
            const inBN = (0, ethereumjs_util_1.bytesToBigInt)(inBuffer);
            const inSizeBN = (0, ethereumjs_util_1.bytesToBigInt)(inSizeBuffer);
            const inPosition = inSizeBN === 0n ? inSizeBN : inBN + inSizeBN;
            const outBN = (0, ethereumjs_util_1.bytesToBigInt)(outBuffer);
            const outSizeBN = (0, ethereumjs_util_1.bytesToBigInt)(outSizeBuffer);
