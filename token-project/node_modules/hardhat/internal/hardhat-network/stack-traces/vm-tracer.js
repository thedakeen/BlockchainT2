...
class VMTracer {
    constructor(_vm, _getContractCode, _throwErrors = true) {
        ...
        this._messageTraces = [];
        this._enabled = false;
        this._maxPrecompileNumber = (0, ethereumjs_evm_1.getActivePrecompiles)(this._vm.common).size;
    ...
    async _beforeMessageHandler(message, next) {
        ...
        try {
            ...
            if (message.to === undefined) {
                ...
                const toAsBigInt = (0, ethereumjs_util_1.bytesToBigInt)(message.to.toBytes());
